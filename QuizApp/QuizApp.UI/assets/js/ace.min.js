    ...
    a(document).on("click.ace.widget", "[data-action]", function(o) {
        ...
        if (p == "collapse") {
            ...
            if (j == "show") {
                ...
                g.slideUp(0, function() { g.slideDown(e, function() { b.trigger(c = a.Event(f + ".ace.widget")); }); });
            } else {
                if (m) {
...
ace.switch_direction = function(d) {
    ...
    c.toggleClass("rtl").find(".dropdown-menu:not(.datepicker-dropdown,.colorpicker)")
    ...
    function a(h, g) {
        c.find("." + h).removeClass(h)
            .addClass("tmp-rtl-" + h).end()
            .find("." + g).removeClass(g)
            .addClass(h).end().find(".tmp-rtl-" + h)
